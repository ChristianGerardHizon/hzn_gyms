...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_eoIu")

  // remove field
  collection.fields.removeById("json2257754847")

  // remove field
  collection.fields.removeById("_clone_nONK")

  // remove field
  collection.fields.removeById("_clone_ruhS")
