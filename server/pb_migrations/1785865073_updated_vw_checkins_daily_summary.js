...
migrate((app) => {
  ...
  unmarshal({
    "viewQuery": "SELECT\n  (ROW_NUMBER() OVER()) AS id,\n  DATE(c.checkInTime, '+8 hours') AS checkin_date,\n  c.branch,\n  c.method,\n  COUNT(*) AS checkin_count,\n  COUNT(DISTINCT c.member) AS unique_members\nFROM checkIns c\nGROUP BY DATE(c.checkInTime, '+8 hours'), c.branch, c.method\nORDER BY checkin_date DESC"
  }, collection)
  ...
  // remove field
  collection.fields.removeById("_clone_H9sc")

  // remove field
  collection.fields.removeById("_clone_SkEV")
