...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_As4g")

  // remove field
  collection.fields.removeById("_clone_vVWZ")

  // remove field
  collection.fields.removeById("_clone_ZUwy")

  // remove field
  collection.fields.removeById("_clone_QtbV")

  // remove field
  collection.fields.removeById("_clone_6BPX")

  // remove field
  collection.fields.removeById("_clone_NRTf")

  // remove field
  collection.fields.removeById("_clone_T3bC")
