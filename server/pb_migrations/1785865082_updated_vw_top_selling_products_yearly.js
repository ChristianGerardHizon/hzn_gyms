...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_maof")

  // remove field
  collection.fields.removeById("_clone_98L3")

  // remove field
  collection.fields.removeById("_clone_Bzp8")
